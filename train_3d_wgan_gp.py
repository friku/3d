...
# summary writer
summary_writer = tf.summary.FileWriter('./summaries/3dganFakeOnbias', sess.graph)

''' initialization '''
ckpt_dir = './checkpoints/3dganFakeOnbias'
...
try:
    ...
    for it in range(sess.run(it_cnt), max_it):
        ...
        if (it + 1) % 100 == 0:
            ...
            save_dir = './sample_images_while_training/3dganFakeOnbias'
