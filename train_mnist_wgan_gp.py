...
# summary writer
summary_writer = tf.summary.FileWriter('./summaries/mnist_wgan_gp_test_500', sess.graph)

''' initialization '''
ckpt_dir = './checkpoints/mnist_wgan_gp_test_500'
...
try:
    ...
    for it in range(sess.run(it_cnt), max_it):
        ...
        if (it + 1) % 100 == 0:
            ...
            save_dir = './sample_images_while_training/mnist_wgan_gp_test_500'
